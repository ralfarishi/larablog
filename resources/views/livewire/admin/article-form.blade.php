<div class="space-y-6">
  ...
  >
    ...
    >
      <div
        class="bg-card ring-border flex min-h-[500px] flex-col rounded-[2.5rem] p-8 shadow-sm ring-1 sm:p-10"
      >
        <h4
          class="text-muted-foreground mb-6 flex items-center gap-2 text-sm font-bold tracking-widest uppercase"
        >
    ...
    <!-- Sidebar Options -->
    <div @class (['flex flex-col gap-8', 'hidden' => $editorMode !== 'write'])>
      <!-- Publishing Box -->
        ...
        <div class="space-y-6">
          ...
          <div class="space-y-3">
            ...
            <div class="grid grid-cols-2 gap-3">
              <!-- Comments -> Yes -->
              <label class="group relative cursor-pointer">
                <input type="radio" wire:model="allowed_comment" value="1" class="peer sr-only" />
                <div
                  class="border-border bg-card text-muted-foreground group-hover:border-primary/50 peer-checked:border-primary peer-checked:bg-primary/10 peer-checked:text-primary peer-checked:shadow-primary/10 flex flex-col items-center justify-center gap-1.5 rounded-xl border-2 p-3 shadow-sm transition-all"
                >
              ...
              <!-- Comments -> No -->
              <label class="group relative cursor-pointer">
                <input type="radio" wire:model="allowed_comment" value="0" class="peer sr-only" />
                <div
                  class="border-border bg-card text-muted-foreground group-hover:border-primary/50 peer-checked:border-primary peer-checked:bg-primary/10 peer-checked:text-primary peer-checked:shadow-primary/10 flex flex-col items-center justify-center gap-1.5 rounded-xl border-2 p-3 shadow-sm transition-all"
                >
